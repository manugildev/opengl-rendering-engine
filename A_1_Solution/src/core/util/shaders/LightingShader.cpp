...
void LightingShader::set_object_color(glm::vec3 object_color) {
	modify_vec3(location_object_color, object_color);
}

void LightingShader::set_light_pos(glm::vec3 light_pos) {
	modify_vec3(location_light_pos, light_pos);
}

void LightingShader::set_light_color(glm::vec3 light_color) {
	modify_vec3(location_light_color, light_color);
}

void LightingShader::set_model_matrix(glm::mat4 matrix) {
