...
class CubeMap {
public:
	CubeMap(int size=1000, std::string front=FRONT_CM, std::string back=BACK_CM, std::string top=TOP_CM, std::string bottom=BOTTOM_CM, std::string left=LEFT_CM, std::string right=RIGHT_CM);
	GLfloat points[108] = {
